    ...
    <footer class="main-footer">
    	...
    	<div class="copyright">Copyright © <?php echo date('Y'); ?> <i>&copy; Powered <a href="https://qloudpointsolutions.com/" target="_blank" >Qloud Point Solutions Ltd. </a></i>, All rights reserved.</div>
    </footer>
</div>
<!-- End Wrapper -->
