...
class User 
{
	...
	private $db;           // Declare $db explicitly
	private $request;      // Declare $request explicitly
	private $session;      // Declare $session explicitly

	public function __construct($registry)
	{
		$this->db = $registry->get('db');            // Changed from registry() to $registry
		$this->request = $registry->get('request');  // Changed from registry() to $registry
		$this->session = $registry->get('session');  // Changed from registry() to $registry
