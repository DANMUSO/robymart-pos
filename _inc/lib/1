...
class Currency 
{
	...
	private $db;         // Declare property for db
	private $request;    // Declare property for request

	public function __construct($registry) 
	{
		$this->db = $registry->get('db'); // Initialize db property
		$this->request = $registry->get('request'); // Initialize request property
