<div class="progress-group-container">
  <div class="progress-group">
    ...
    <div class="progress sm">
      <div class="progress-bar progress-bar-aqua" style="width: <?php echo $invoice_amount > 0 ? get_progress_percentage($invoice_amount, $discount_amount + $due_amount) : 0;?>%"></div>
    </div>
  </div>
  <div class="progress-group">
    ...
    <div class="progress sm">
      <div class="progress-bar progress-bar-warning" style="width:<?php echo $invoice_amount > 0 ? ($discount_amount / $invoice_amount) * 100 : 0;?>%"></div>
    </div>
  </div>
  <div class="progress-group">
    ...
    <div class="progress sm">
      <div class="progress-bar progress-bar-red" style="width: <?php echo $invoice_amount > 0 ? ($due_amount / $invoice_amount) * 100 : 0;?>%"></div>
    </div>
  </div>
  <div class="progress-group">
    ...
    <div class="progress sm">
      <div class="progress-bar progress-bar-success" style="width: <?php echo $invoice_amount > 0 ? ($received_amount / $invoice_amount) * 100 : 0;?>%"></div>
    </div>
  </div>
  <a href="report_overview.php?type=sell" class="btn btn-sm btn-block btn-warning btn-flat"><?php echo trans('button_overview_report'); ?> &rarr;</a>
</div>
