			...
			<div class="tab-wrapper tab-cheque bootboox-container tab-cheque-payment">
				...
				<div class="mt-5">
					<div class="input-group input-group-xs pmethod-field-wrapper">
				        ...
				        <h2>Total Due: &nbsp; &nbsp;<span style="color: #358e10 !important;"><strong>Ksh {{ totalPayable  | formatDecimal:2  }}</strong></span></h2>
				    	<h2>Balance: &nbsp; &nbsp;<span style="color: #f00 !important;"><strong>Ksh {{ totalPayable < paidAmount ? paidAmount - totalPayable  : 0 | formatDecimal:2 }}</strong></span></h2>
			...
			<div class="table-responsive">
				<table class="table table-bordered table-striped table-condensed">
					...
					<tfoot>
						...
						<tr>
							<th class="text-right w-40" colspan="2" style="font-size: 30px; ">
								<?php echo trans('label_balance'); ?>
							</th>
							<td class="text-right w-60" style="font-size: 25px; color: #dd4b39;"><strong>{{ totalPayable < paidAmount ? paidAmount - totalPayable  : 0 | formatDecimal:2 }}</strong></td>
						</tr>
