		...
		<div class="col-lg-5 col-md-5 col-sm-5 bootboox-container pmethod-option checkout-payment-option">
			<div class="tab-wrapper tab-cheque bootboox-container tab-cheque-payment">
				...
				<div class="input-group input-group-lg">
					...
					<input ng-init="paidAmount=(order.payable_amount - order.due_paid)" class="form-control" name="paid-amount" ng-model="paidAmount" placeholder="<?php echo trans('placeholder_input_an_amount'); ?>" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" onKeyUp="if(this.value<0){this.value='1';}">
				</div>
				<div class="mt-5">
				...
				<table class="table table-bordered table-striped table-condensed">
					...
					<tfoot>
						...
						<tr ng-repeat="payments in order.payments" class="{{ 'success' }}">
							...
							<td ng-show="payments.type=='change'" class="text-right w-40" style="font-size: 20px;">{{ payments.pos_balance | formatDecimal:2 }}</td>
						</tr>
						<!-- Payments end -->
